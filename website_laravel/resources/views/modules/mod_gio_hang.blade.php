        ...
        <table class="table table-hover gio_hang">
            ...
            <tbody>
                ...
                <tr id="san_pham_{{$sp_gio_hang->id}}">
                    ...
                    <td><input class="so_luong_input" id="so_luong_{{$sp_gio_hang->id}}" onchange="thay_doi_so_luong_gio_hang({{$sp_gio_hang->id}})" type="number" name="so_luong[]" value="{{$sp_gio_hang->so_luong}}"></td>
