    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            @if(isset($list_sach_noi_bat))
                @foreach($list_sach_moi as $sach_moi)
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 item_sp_noi_bat">
                        ...
                        <div class="thong_tin_tom_tat_sach">
                            <a href="/sach/{{$sach_moi->id}}">
                                ...
                                <div class="tac_gia">{{$sach_moi->ten_tac_gia}}</div>
                                <div class="don_gia_ban">{{$sach_moi->don_gia}} ₫</div>
                                <div class="don_gia_bia">{{$sach_moi->gia_bia}} ₫ </div>
                            </a>
                            <a href="them_vao_gio_hang.php?id_sach={{$sach_moi->id}}">
                                <div class="btn_mua_ngay" data-id-sach="{{$sach_moi->id}}">Mua Ngay</div>
                            </a>
                        </div>
